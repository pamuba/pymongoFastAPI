...
from schemas.todos_schema import todos_serializer, todo_serializer, todo_single_serializer

from bson import ObjectId


#create an object of APIRouter to be used in the routes
...
async def get_todo(id: str):
    return todo_single_serializer(collection_name.find_one({"_id": ObjectId(id)}))
